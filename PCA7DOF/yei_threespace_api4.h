...
int openDevice() // I could possibly accept the filename string
{
...
//  165(0xa5) dongle command type or streaming commands type
int calibrateGyro(int fd_, int deviceNum)
