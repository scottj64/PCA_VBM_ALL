...
//g++ -std=c++11 -pthread PCA_7DOF_01.cpp -ldl -o PCA_7DOF_01 
...
//		return 1; //just in case?
	...
	const char configFileName[] = "ConfigFilePCA.txt";
	...
	strcat(outputFilename,"_PCA_Session.txt");
	
	printf("Will create file \"%s/%s_PCA_Session.txt\" for next test.\nDo you wish to continue? -y\n", argv[1], timeBuffer);
