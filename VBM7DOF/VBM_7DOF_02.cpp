...
// g++ -std=c++11 -pthread VBM_7DOF_02.cpp -ldl -o /home/aspelun1/Documents/IncrementalLearning//VBM_7DOF
...
//	printf("Will create file \"%s/VBM_Session_%d.txt\" for next test.\nDo you wish to continue? -y\n", argv[1], NUM_OF_DOFs);
...
//	parameterFile.close();
	...
	printf ("Output file \"%s/VBM_Session_%d.txt\" closed.\n", argv[1], NUM_OF_DOFs);
