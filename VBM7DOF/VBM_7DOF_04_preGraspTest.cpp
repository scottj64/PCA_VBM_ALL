...
// g++ -std=c++11 -pthread VBM_7DOF_04_preGraspTest.cpp -ldl -o /home/aspelun1/Documents/IncrementalLearning/VBM_7DOF_preGraspTest
...
//		pointToSend.Limitations.speedParameter2 = 0.7;
		...
		pointToSend.Position.CartesianPosition.X = -START_X-0.05;
		pointToSend.Position.CartesianPosition.Y = -START_Y-0.05;
		pointToSend.Position.CartesianPosition.Z =	START_Z+.2;
...
//				case 'h': memcpy(&pointToSend, &startPoint,sizeof(pointToSend)); break;
