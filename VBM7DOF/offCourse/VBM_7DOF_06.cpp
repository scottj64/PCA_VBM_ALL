...
// g++ -std=c++11 -pthread VBM_7DOF_05.cpp -ldl -o /home/aspelun1/Documents/IncrementalLearning/VBM_7DOF
...
#include "matlab_nonThread_7DOF_1.h"
...
//		printf("yabadabadoo");
		...
		pointToSend.Position.Fingers.Finger1 = 5500.0f;
...
//		printf("%6.4f\t%6.4f\t%6.4f\n",pointToSend.Position.CartesianPosition.X, pointToSend.Position.CartesianPosition.Y, pointToSend.Position.CartesianPosition.Z);
...
*/		currDP.fingerSVal = (data.Fingers.Finger1 + data.Fingers.Finger2 + data.Fingers.Finger3) / 3;
		...
		matlabFunction(&currDP, BIMUnode, p, GMapping);
...
//		
////		follow a circle
//		currDP.rawCartVel[0] = (CenterX + 0.1*cos(currDP.programTime*0.25) - currDP.currentLoc[0]);
//		currDP.rawCartVel[1] = (StartY - currDP.currentLoc[1]);
//		currDP.rawCartVel[2] = (CenterZ + 0.1*sin(currDP.programTime*0.25) - currDP.currentLoc[2]);
...
//		currDP.fingersTold = (3000.0 + 2000.0*sin(currDP.programTime*0.25) - currDP.fingerSVal) * fingerGain;
//		
//		
